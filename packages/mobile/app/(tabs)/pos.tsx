...
const styles = StyleSheet.create({
  ...
  rcShopName: { fontSize: 22, fontWeight: "900", color: "#111", textAlign: "center", alignSelf: "stretch", letterSpacing: 0.5, marginBottom: 2, textTransform: "uppercase" },
  ...
  rcNetPayLabel: { fontSize: 20, fontWeight: "900", color: colors.primary },
  rcNetPayVal: { fontSize: 20, fontWeight: "900", color: colors.primary },
