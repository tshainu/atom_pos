        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <SectionCard title="Personal Info">
            ...
            <Field label="Photo URL">
              <TextInput style={styles.input} value={form.photoUrl} onChangeText={(v) => set("photoUrl", v)} placeholder="https://..." placeholderTextColor={colors.textSecondary} autoCapitalize="none" />
            </Field>
          </SectionCard>

          <SectionCard title="Login Credentials">
            <Field label="Username (cannot change)">
              <View style={styles.readonlyBox}>
                <Text style={styles.readonlyText}>{form.username}</Text>
              </View>
            </Field>
...
const styles = StyleSheet.create({
  ...
  readonlyBox: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, paddingHorizontal: spacing.md, paddingVertical: 11, backgroundColor: "#F0F0F0" },
